...
/// <summary>
/// Validator for car make creation requests
/// </summary>
public class CarMakeCreateRequestValidator : AbstractValidator<CarMakeRequest>
{
    public CarMakeCreateRequestValidator()
    {
        RuleFor(x => x.Name)
            .NotEmpty()
