...
/// <summary>
/// Validator for car model creation requests
/// </summary>
public class CarModelCreateRequestValidator : AbstractValidator<CarModelRequest>
{
    public CarModelCreateRequestValidator()
    {
        RuleFor(x => x.MakeId)
            .NotEmpty()
